...
!function (e) {
    ...
    !function (e, o) {
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
            ...
            value: "值",
            cancel: "取消"
        })), kendo.ui.FilterMultiCheck && (kendo.ui.FilterMultiCheck.prototype.options.messages = e.extend(!0, kendo.ui.FilterMultiCheck.prototype.options.messages, {search: "搜索"})), kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            string: {
                eq: "等于",
                neq: "不等于",
                startswith: "开头为",
            ...
            number: {eq: "等于", neq: "不等于", gte: "大于等于", gt: "大于", lte: "小于等于", lt: "小于"},
            date: {eq: "等于", neq: "不等于", gte: "大于等于", gt: "大于", lte: "小于等于", lt: "小于"},
            enums: {eq: "等于", neq: "不等于"}
            ...
            views: {
                ...
                week: "周",
                month: "月"
            }, actions: {append: "添加任务", addChild: "添加子任务", insertBefore: "添加到前面", insertAfter: "添加到后面"}
            ...
            commands: {
                ...
                select: "选择",
                update: "更新"
            }, editable: {cancelDelete: "取消", confirmation: "确定要删除吗？", confirmDelete: "删除"}, noRecords: "没有可用的记录。"
        })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "拖拽列标题到此处按列组合显示"})), kendo.ui.ImageBrowser && (kendo.ui.ImageBrowser.prototype.options.messages = e.extend(!0, kendo.ui.ImageBrowser.prototype.options.messages, {
            uploadFile: "上传",
            orderBy: "排序条件",
            orderByName: "名称",
            orderBySize: "大小",
            ...
            hourly: {repeatEvery: "重复周期: ", interval: " 小时"},
            daily: {repeatEvery: "重复周期: ", interval: " 天"},
            weekly: {interval: " 周", repeatEvery: "重复周期: ", repeatOn: "重复于:"},
            monthly: {repeatEvery: "重复周期: ", repeatOn: "重复于:", interval: " 月", day: "日期"},
            yearly: {repeatEvery: "重复周期: ", repeatOn: "重复于: ", interval: " 年", of: " 月份: "},
            end: {label: "截止时间:", mobileLabel: "截止时间", never: "从不", after: "重复 ", occurrence: " 次后", on: "止于 "},
            offsetPositions: {first: "第一", second: "第二", third: "第三", fourth: "第四", last: "最后"},
            weekdays: {day: "天", weekday: "工作日", weekend: "周末"}
            ...
            editable: {confirmation: "你确定你要删除这个活动？"},
            views: {day: "日", week: "周", workWeek: "工作日", agenda: "日程", month: "月"},
            recurrenceMessages: {
            ...
            url: "{0} 不是合法的URL",
            date: "{0} 不是合法的日期"
        })),kendo.ui.Confirm && (kendo.ui.Confirm.prototype.options.messages=kendo.ui.Alert.prototype.options.messages=kendo.ui.Prompt.prototype.options.messages = e.extend(!0, kendo.ui.Confirm.prototype.options.messages,  {
            okText: "确定", 
            cancel: "取消"
        })),kendo.ui.Dialog && (kendo.ui.Dialog.prototype.options.messages = e.extend(!0, kendo.ui.Dialog.prototype.options.messages,  {
            close: "关闭"
        }))
        // console.log(kendo.ui)
        // for(var i in kendo.ui){
        //     if(kendo.ui[i].prototype && kendo.ui[i].prototype.options && kendo.ui[i].prototype.options.messages){
        //         console.log(i)
        //          console.log(kendo.ui[i].prototype.options.messages)
        //     }
        // }
    }(window.kendo.jQuery)
});
